...
const FAQ = () => {
  const generalFAQs = [
    ...
    },
    {
      ...
      answer: "לא נדרש כל רקע טכני או עסקי קודם. התכנית מעוצבת כך שתתאים גם למשתתפים ללא ניסיון בתכנות או בפיתוח."
    },
    {
    ...
    },
    {
      ...
      answer: "עלות הקייטנה למשתתף היא 1,600 ₪."
    }
  ];
  ...
  const technicalFAQs = [
    ...
    },
    {
      ...
      answer: "גודל הקבוצה נע בין 10 ל-15 משתתפים."
    },
    {
  ...
  const programFAQs = [
    ...
    },
    {
      ...
      answer: "הפיתוח מתבצע באמצעות כלים המאפשרים בניית אפליקציות ורכיבים דיגיטליים ללא צורך בכתיבת קוד. זה מאפשר לבני נוער לפתח אפליקציות שלמות במהירות ובקלות, גם ללא ידע בתכנות."
    },
    {
      question: "כיצד משולבת בינה מלאכותית בתכנית?",
      answer: "התכנית מאפשרת למשתתפים לרתום את כוחה של בינה מלאכותית ליצירת תוכן ועיצוב אפליקציות, אפיון ומחקר, כתיבת תוכן ופיתוח טכנולוגי. הם יכירו עקרונות יזמות דיגיטלית מודרנית מבוססת בינה מלאכותית, ילמדו על מחקר שוק אוטומטי, בניית מודל עסקי חכם, ועיצוב חוויית משתמש עם בינה מלאכותית."
    },
    {
      question: "אילו כלים ופלטפורמות מרכזיות ישמשו בקייטנה?",
      answer: "המשתתפים יתמקדו בפלטפורמות כמו Canva בינה מלאכותית Assistant, Rosebud בינה מלאכותית, Bubble, Lovable.dev, Firebase Studio, Replit Ghostwriter, MagicSchool בינה מלאכותית, Diffit, Base44, Websim, ו-Google בינה מלאכותית Studio."
    },
    {
      question: "מהם יעדי הלמידה העיקריים של הקייטנה?",
      answer: "יזמות דיגיטלית: פיתוח חשיבה יזמית, זיהוי הזדמנויות עסקיות, למידת עקרונות מחקר שוק, בניית מודל עסקי והצגת פרויקטים עסקיים. פיתוח אפליקציות: שימוש בכלי בינה מלאכותית ליצירת אפליקציות פועלות, הבנת עקרונות עיצוב UI/UX, ולמידת תהליכי בדיקה ושיפור מוצר. מיומנויות דיגיטליות: היכרות עם למעלה מ-10 פלטפורמות בינה מלאכותית, פיתוח כישורי פתרון בעיות, חשיבה אלגוריתמית, עבודת צוות ומנהיגות."
    },
    {
  ...
  const outcomesFAQs = [
    ...
    },
    {
      ...
      answer: "הקייטנה מכוונת לפתח מנטליות של יזמות מבוססת בינה מלאכותית, להקנות מיומנויות טכנולוגיות (פיתוח, עיצוב ומחקר משתמשים עם סיוע בינה מלאכותית), לפתח אוריינות בינה מלאכותית (הבנה, שימוש והערכה ביקורתית של כלי בינה מלאכותית), לצבור ניסיון במנהיגות דיגיטלית ועבודת צוות, ולהבין יסודות עסקיים בעידן הבינה המלאכותית."
    }
  ];
  ...
  const specialFAQs = [
    ...
    {
      question: "האם הקייטנה מתאימה לבני נוער עם קשיי למידה או צרכים מיוחדים?",
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-600">[פתיח חדש יתווסף בהמשך]</p>
          </div>
        </div>
      </section>
